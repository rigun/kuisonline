        ...
        >
            <v-card>
                ...
                <v-card-text>
                        ...
                        <v-flex xs12>
                            <editor api-key="6igj5g6zwo9p5n58vrpw7ea8aph3ft79j7v8322mmay4ado7 " v-model="editData.body" :init="{plugins: 'wordcount image imagetools'}" :height='1000'></editor>
                        </v-flex>
                </v-card-text>
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="red darken-1" dark @click.prevent="goto('manageCase')">Kembali</v-btn>
                    <v-btn color="green darken-1" dark @click.prevent="SendData()" :loading="load">Tambahkan</v-btn>
                </v-card-actions>
                </v-card>
                </v-form>
<v-snackbar
